...
typedef struct {
    i2c_device_config_t led_driver_device;  /*!< Configuration for led driver device */
    uint8_t row_count;               /*!< Number of rows driven by matrix */
    uint8_t col_count;              /*!< Number of columnds driven by matrix*/
} i2c_led_driver_config_t;

struct i2c_led_driver_t {
...
typedef struct i2c_led_driver_t i2c_led_driver_t;
